...
$ ng serve
# or
$ ibazel run //angular/src:devserver
```
...
$ ng serve --prod
# or
$ bazel run //angular/src:prodserver
```
...
`//angular/src:devserver` target does not serve a code split bundle. The dynamic
